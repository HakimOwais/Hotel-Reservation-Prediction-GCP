...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            ...
            logger.info("Data splitted into train and test set successfully")
    ...
    def train_model(self, X_train, y_train):
        try:
            ...
            logger.info("Starting hyperparameter tuning using random Search cv")
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("Logging the traing and testing dataset to MLFLOW")
